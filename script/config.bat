...
set BUILD_NAME=TFModFortRisePickupArrowBomb
set DLL_MOD_FILE_NAME=TFModFortRisePickupArrowBomb.dll
set PDB_MOD_FILE_NAME=TFModFortRisePickupArrowBomb.pdb
set MODULE_DIR_NAME=tf-mod-fortrise-pickup-arrowbomb

set REPO_PATH=D:\__dev\code\FR5tf-mod-fortrise-pickup-arrowbomb\
set REPO_BUILD_PATH=%REPO_PATH%VSCode\bin\Debug\net10.0\
set REPO_RELEASE_PATH=%REPO_PATH%release\
set REPO_RELEASE_MOD_PATH=%REPO_RELEASE_PATH%\tf-mod-fortrise-pickup-arrowbomb\
